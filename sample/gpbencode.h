...
namespace io{
	...
	public:
		...
		bool ReadLittleEndian64(uint64* value){
			...
			return true;
#else
			uint32 part0 = (static_cast<uint32>(buffer_[0])      ) |
				(static_cast<uint32>(buffer_[1]) <<  8) |
				(static_cast<uint32>(buffer_[2]) << 16) |
				(static_cast<uint32>(buffer_[3]) << 24);
...
public:
	...
	inline static WireType GetTagWireType(uint32 tag) {
...
class gpbdecoder
{
	//only int32 int64 uint32 uint64 float double bool string
	//no sint32 sint64 fixed32 fixed64
public:
	gpbdecoder(){}
	~gpbdecoder(){}
...
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, int32* value){
...
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, int64* value){
	return WireFormatLite::ReadPrimitive<int64, WireFormatLite::TYPE_INT64>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, uint32* value){
	return WireFormatLite::ReadPrimitive<uint32, WireFormatLite::TYPE_UINT32>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, uint64* value){
	return WireFormatLite::ReadPrimitive<uint64, WireFormatLite::TYPE_UINT64>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, float* value){
	return WireFormatLite::ReadPrimitive<float, WireFormatLite::TYPE_FLOAT>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, double* value){
	return WireFormatLite::ReadPrimitive<double, WireFormatLite::TYPE_DOUBLE>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, bool* value){
	return WireFormatLite::ReadPrimitive<bool, WireFormatLite::TYPE_BOOL>(input, value);
}
template <>
inline bool gpbdecoder::ReadPrimitive(io::CodedInputStream* input, string* value){
...
public:
	...
	INL static uint8* WriteMapToArray(field_number, map<TKey, TValue>& value, output){
		for(typename map<TKey, TValue>::iterator itr = value.begin(); itr != value.end(); ++itr){
...
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, int32 value, output){
...
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, int64 value, output){
	return WireFormatLite::WriteInt64ToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, uint32 value, output){
	return WireFormatLite::WriteUInt32ToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, uint64 value, output){
	return WireFormatLite::WriteUInt64ToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, float value, output){
	return WireFormatLite::WriteFloatToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, double value, output){
	return WireFormatLite::WriteDoubleToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, bool value, output){
	return WireFormatLite::WriteBoolToArray(field_number_arg, value, target);
}
template<>
INL uint8* gpbencoder::WriteDataToArray(field_number, string value, output){
	return WireFormatLite::WriteStringToArray(field_number_arg, value, target);
}

template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(int32 value, output){
	//return io::CodedOutputStream::WriteVarint32SignExtendedToArray(value, target);
	return io::CodedOutputStream::WriteVarint32ToArray(WireFormatLite::ZigZagEncode32(value), target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(int64 value, output){
	return io::CodedOutputStream::WriteVarint64ToArrayInline(value, target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(uint32 value, output){
	return io::CodedOutputStream::WriteVarint32ToArray(value, target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(uint64 value, output){
	return io::CodedOutputStream::WriteVarint64ToArrayInline(value, target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(float value, output){
	return io::CodedOutputStream::WriteLittleEndian32ToArray(WireFormatLite::EncodeFloat(value), target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(double value, output){
	return io::CodedOutputStream::WriteLittleEndian64ToArray(WireFormatLite::EncodeDouble(value), target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(bool value, output){
	return io::CodedOutputStream::WriteVarint32ToArray(value ? 1 : 0, target);
}
template<>
INL uint8* gpbencoder::WriteNoTagDataToArray(string value, output){
	target = io::CodedOutputStream::WriteVarint32ToArray(value.size(), target);
	return io::CodedOutputStream::WriteRawToArray(value.data(), static_cast<int>(value.size()), target);
}

template<>//for string or message, it write the string or message one by one directly, not together.
INL uint8* gpbencoder::WriteRepeatedToArray(field_number, vector<string>& value, output){
	int count = (int)value.size();
	for(int i = 0; i < count; ++i){
...
public:
	...
	static std::string tostr(const map<TK, TV> &m) 
	{
		std::ostringstream sBuffer;
		sBuffer<<"map{("<<m.size()<<")";
		for(typename map<TK, TV>::const_iterator itr = m.begin(); itr != m.end(); ++itr)
